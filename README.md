...
- Clone this repository: git clone https://github.com/VHAINNOVATIONS/TheDailyPlan.git
...
You can build the machine in AWS as follows:
```
vagrant up --provider=aws
```

To connect to roll and scroll VistA
```
vagrant ssh
csession cache
```
...
Important EWD Links on TheDailyPlan Development VM
--------------------------------------------
...
EWD Federator: http://192.168.33.11:8081/TDPEwdVista/raptor/
echo password: innovate 

Cache Links on TheDailyPlan Development VM
------------------------------------
