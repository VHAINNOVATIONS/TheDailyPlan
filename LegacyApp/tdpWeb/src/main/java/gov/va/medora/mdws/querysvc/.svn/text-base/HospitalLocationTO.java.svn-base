 ...
 *         &lt;element name="department" type="{http://mdws.medora.va.gov/QuerySvc}TaggedText" minOccurs="0"/>
 *         &lt;element name="service" type="{http://mdws.medora.va.gov/QuerySvc}TaggedText" minOccurs="0"/>
 *         &lt;element name="specialty" type="{http://mdws.medora.va.gov/QuerySvc}TaggedText" minOccurs="0"/>
 *         &lt;element name="facility" type="{http://mdws.medora.va.gov/QuerySvc}SiteTO" minOccurs="0"/>
