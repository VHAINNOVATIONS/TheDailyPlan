...
import gov.med.va.innovations.dao.UserDao;
...
import gov.med.va.innovations.service.UserService;
 ...
 */
@WebService(serviceName = "UserService", endpointInterface = "gov.med.va.innovations.service.UserService")
