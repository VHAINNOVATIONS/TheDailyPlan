...
public final class iBatisDaoUtils {
    ...
    /**
     * @return Returns the paging query name.
     * @param className the name of the class - returns "paging" + className
     */
    public static String getPagingQuery(String className) {
        return "paging" + className;
    }
    

    /**
     * @return Returns the count query name.
     * @param className the name of the class - returns "count" + className
     */
    public static String getCountgQuery(String className) {
