...
public class GenericDaoiBatis<T, PK extends Serializable> extends SqlMapClientDaoSupport implements GenericDao<T, PK> {
	...
	public List<T> findByNamedQuery(String queryName,
		...
		return getSqlMapClientTemplate().queryForList(queryName,queryParams);
	}

	@Override
	public List<T> getAllDistinct() {
		List<T> retrieved = getAll();
		SortedSet<T> s = Collections.synchronizedSortedSet(new TreeSet<T>(retrieved));
