...
SET IDENTITY_INSERT "facility_message" ON ;
...
SET IDENTITY_INSERT "facility_message" OFF;
...
SET IDENTITY_INSERT "panel" OFF;

CREATE TABLE "panel_detail" (
  "id" int NOT NULL,
  "panel_id" int NOT NULL,
  "panel_setting_id" int NOT NULL,
...
CREATE TABLE "panel_type" (
  ...
  "minSizeX" int DEFAULT NULL,
  "minSizeY" int DEFAULT NULL,
...
SET IDENTITY_INSERT "panel_type" ON ;
...
SET IDENTITY_INSERT "panel_type" OFF;
...
CREATE TABLE "template" (
  ...
  "template_owner" int DEFAULT NULL,
  "createdAt" datetime DEFAULT NULL,
  "updatedAt" datetime DEFAULT NULL,
  PRIMARY KEY ("id"),
...
SET IDENTITY_INSERT "template_layout" ON ;
...
SET IDENTITY_INSERT "template_layout" OFF;
