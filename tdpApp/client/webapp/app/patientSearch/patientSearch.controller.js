...
angular.module('tdpApp')
  .controller('PatientSearchCtrl', function ($compile, $scope, $resource, $location, DTOptionsBuilder, DTColumnBuilder, Patient, Location, Auth, Audit) {
  	var self = this;
    self.data = [];
    self.items = [];
    self.wards = [];
